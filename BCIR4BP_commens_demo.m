...
l_star = ((N / D)^2 / muS) ^ (1/3) * aE_dim;  % Also equal to the average SMA of the Moon about EM Bary
...
% Load in L4 SPOs for propagation
...
Q_mult = 3;
Q = round(Q_mult * (l4_short_period(44).TIP / 2 / pi / D)^-1);
...
T_repeat_nd = 2 * pi * D * Q_mult

% Repitition period, but now dimensionalized
